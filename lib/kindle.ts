...
<container version="1.0" xmlns="urn:oasis:names:tc:opendocument:xmlns:container">
  ...
  if (coverPath) {
    ...
    manifestItems.unshift(`<item id="cover-image" href="images/cover.jpg" media-type="image/jpeg" properties="cover-image"/>`);
  }
  ...
  chapters.forEach((ch, i) => {
    ...
    chapterFolder.file(`${id}.xhtml`, chapterXhtml(ch.html, '../styles/ebook.css'));
...
<package xmlns="http://www.idpf.org/2007/opf" version="3.0" unique-identifier="uid">
  <metadata xmlns:dc="http://purl.org/dc/elements/1.1/">
    <dc:identifier id="uid">formation-framework-2026</dc:identifier>
    <dc:title>The Formation Framework</dc:title>
